...
export function LoginView({ onRegister, onSuccess }: LoginViewProps) {
    ...
    const initGsi = () => {
      ...
      try {
        ...
        if (googleBtnRef.current) {
          ...
          const buttonWidth = Math.min(380, Math.max(280, Math.floor(containerWidth)));
  ...
  async function handleGoogleLogin() {
    // If Google GIS is ready and user clicks the button directly, try prompt()
    ...
    // Fallback for tests or when GIS script is not loaded
  ...
  return (
    <section id="loginView" className="page-shell auth-view">
      <div className="auth-card">
        ...
        <div className="google-auth-wrapper" style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", minHeight: "44px" }}>
          ...
          <div
            ...
            style={{
              width: "100%",
              display: isGsiReady ? "flex" : "none",
              justifyContent: "center",
            }}
          />

          {/* Fallback button shown when GSI is loading or in test environments */}
          {!isGsiReady && (
            <button
              type="button"
